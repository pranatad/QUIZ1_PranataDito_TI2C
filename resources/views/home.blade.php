                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mapimg">
                                <div class="text-bg">
                                    <h1>The latest <br> <strong class="black_bold">WAIFU</strong><br></h1>
                                    <a href="#">Kato Megumi<i class='fa fa-angle-right'></i></a>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="text-img">
                                    <figure><img src="images/bg.gif" /></figure>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="carousel-caption text">
                                    <div class="row">
                                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                                            <div class="img_bg">
                                                <h3>Pranata Dito Fitriyansyah<br> <strong class="black_nolmal">TI - 2C</strong></h3>
                                            </div>
                                        </div>
